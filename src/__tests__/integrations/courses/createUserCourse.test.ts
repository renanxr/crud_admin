...
describe('Testando rota de criação de matricula do usuário em um curso', () => {
	...
	it('POST /courses/:courseId/users/:userId - Sucesso: Vinculando um usuário com um curso passando token de admin.', async () => {
	...
	it('POST /courses/:courseId/users/:userId - Error: Vinculando user a um curso que não existe', async () => {
		const response = await supertest(app)
	...
	it('POST /courses/:courseId/users/:userId - Erro: Cadastrando curso com o token de não admin.', async () => {
		const response = await supertest(app)
			.post(`/courses/${couseHTML.id}/users/${userAdmin.id}`)
	...
	it('POST /courses/:courseId/users/:userId - Erro: Cadastrando curso sem enviar token.', async () => {
	...
	it('POST /courses/:courseId/users/:userId - Erro: Cadastrando curso enviando token errado.', async () => {
		const response = await supertest(app)
			.post(`/courses/${couseHTML.id}/users/${userAdmin.id}`)
